...
export const Post = () => {
  return (
    <>
      <article className="shadow-lg pr-5">
        <div className="flex justify-center gap-4 max-sm:flex-wrap  ">
          <div className="relative basis-[44%] max-sm:basis-[80%] aspect-[2/3.5] max-sm:aspect-[1/1]">
            ...
            <div className="absolute bottom-5 left-[13%] max-lg:left-[25%] max-sm:left-[33%] flex justify-center gap-4 text-xl max-xl:text-sm max-lg:text-xs max-sm:text-2xl">
          ...
          <div className="flex flex-col basis-[53%] max-sm:basis-[80%] aspect-[1/1] max-sm:aspect-[1/1] justify-evenly">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-1 text-xs max-sm:text-lg">
            ...
            <button className="font-bold text-sm max-sm:text-lg leading-6 font-montserrat text-primary border-solid border-[1px] border-primary w-[40%] rounded-3xl py-1 ">
