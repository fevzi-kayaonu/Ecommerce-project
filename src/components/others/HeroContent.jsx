...
const HeroContent = () => {
  return (
    <>
      {" "}
      <div className="flex relative w-[90%] m-auto md:pl-[7%] items-center justify-center bg-gradient-to-r from-heroLeft to-heroRight z-[-2] rounded-2xl max-md:flex-wrap max-md:gap-9">
